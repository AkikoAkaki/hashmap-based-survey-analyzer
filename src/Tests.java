...
public class Tests {
  ...
  public static void main(String[] args) {
    ...
    testInstance.analyzer = new SurveyDataAnalyzer(ReadFile.readResponsesFromFile("responses.txt"));
    System.out.println("Testing method 1:");
    int[] test1 =
        testInstance.analyzer.genderDistribution(); // Call the method to get the test results
    ...
    int[] test2 =
        testInstance.analyzer.ageGroupDistribution(); // Call the method to get the test results
    ...
    int[] test3 =
        testInstance.analyzer.residenceDistribution(); // Call the method to get the test results
    ...
    int[] test4 =
        testInstance.analyzer.educationDistribution(); // Call the method to get the test results
    ...
    int[] test5 =
        testInstance.analyzer.incomeDistribution(); // Call the method to get the test results
    ...
    int[] test6 =
        testInstance.analyzer.maritalDistribution(); // Call the method to get the test results
    ...
    int[] test7 =
        testInstance.analyzer.smokerDistribution(); // Call the method to get the test results
    ...
    double test8 =
        testInstance.analyzer.lifeQualityGeneral(); // Call the method to get the test results
    ...
    double[] test9 =
        testInstance.analyzer.lifeQualityGenderBased(); // Call the method to get the test results
    ...
    double[] test10 =
        testInstance.analyzer.lifeQualityAgeBased(); // Call the method to get the test results
    double[] result10 =
        new double[] {19.86842105263158, 23.209302325581394, 31.77173913043478, 37.107142857142854};
    ...
    double[] test11 =
        testInstance.analyzer
            .lifeQualityResidenceBased(); // Call the method to get the test results
    ...
    double[] test12 =
        testInstance.analyzer
            .lifeQualityEducationBased(); // Call the method to get the test results
    double[] result12 =
        new double[] {36.46153846153846, 33.19512195121951, 28.18421052631579, 24.46153846153846};
    ...
    double[] test13 =
        testInstance.analyzer.lifeQualityIncomeBased(); // Call the method to get the test results
    double[] result13 =
        new double[] {25.114942528735632, 38.55357142857143, 35.13157894736842, 28.96875};
    ...
    double[] test14 =
        testInstance.analyzer.lifeQualityMaritalBased(); // Call the method to get the test results
    double[] result14 =
        new double[] {20.310344827586206, 30.875, 30.369565217391305, 35.44444444444444};
    ...
    double[] test15 =
        testInstance.analyzer.lifeQualitySmokerBased(); // Call the method to get the test results
    ...
    String[] test16 =
        testInstance.analyzer.mostCommonTreatment(); // Call the method to get the test results
    String[] result16 =
        new String[] {
          "Chemotherapy", "Surgical", "Radiotherapy", "Immunotherapy", "MolecularlyTargetedTherapy"
        };
    ...
    String[] test17 =
        testInstance.analyzer.mostCommonSymptoms(); // Call the method to get the test results
    String[] result17 =
        new String[] {
          "Weakness",
          "Cough",
    ...
    String[] test18 =
        testInstance.analyzer.mostCommonLifeAspects(); // Call the method to get the test results
    String[] result18 =
        new String[] {
          "PsychologicalAspect",
          "PhysicalAspect",
    ...
    double[] test19 =
        testInstance.analyzer
            .lifeQualityMixConditionsBased(); // Call the method to get the test results
    ...
    double[] test20 =
        testInstance.analyzer.lifeQualityResponseBased(); // Call the method to get the test results
    double[] result20 =
        new double[] {14.222222222222221, 20.87837837837838, 32.3739837398374, 41.07462686567164};
